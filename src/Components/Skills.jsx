      ...
      >
        ...
        <div className="skills-Card-Grid">
          ...
          <div className="skill-Cards">
            ...
            <h3 className="h3-Card ">Frontend Development</h3>
            <p className="P-Card">
          ...
          <div className="skill-Cards">
            ...
            <h3 className="h3-Card ">Backend & Programming</h3>
          ...
          <div className="skill-Cards">
            ...
            <h3 className="h3-Card ">Databases</h3>
            <p className="P-Card">
          ...
          <div className="skill-Cards">
            ...
            <h3 className="h3-Card ">Software Testing (SQA)</h3>
          ...
          <div className="skill-Cards">
            ...
            <h3 className="h3-Card ">Tailwind CSS</h3>
